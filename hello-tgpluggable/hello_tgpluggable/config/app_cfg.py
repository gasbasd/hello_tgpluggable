# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in hello-tgpluggable.
...
import tg
import hello_tgpluggable
from hello_tgpluggable import model
from hello_tgpluggable.lib import app_globals, helpers 
...
base_config.package = hello_tgpluggable
...
base_config.model = hello_tgpluggable.model
base_config.DBSession = hello_tgpluggable.model.DBSession
# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "c3421f32-d762-4409-a582-2d26a5fbda23"
