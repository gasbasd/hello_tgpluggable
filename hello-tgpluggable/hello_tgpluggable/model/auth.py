...
It's perfectly fine to re-use this definition in the hello-tgpluggable application,
though.
...
from hello_tgpluggable.model import DeclarativeBase, metadata, DBSession
